...
export default function EditProduct() {
  ...
  "/productsImg/newArrivals-img/new-img1.webp",  // Replace with your real image URL
  null,
  "https://example.com/products/new-img7.webp",  // Replace with your real image URL
  null,
  null,
]);


    // Fetch the product data (this is a mock function, replace with your actual data fetching logic)
    useEffect(() => {
        const fetchProductData = () => {
            // Replace this mock data with actual API call to fetch product details
            const fetchedProduct = {
                name: "Summer Dress",
                description: "A beautiful summer dress for kids",
                price: "49.99",
                category: "Summer Dress",
                size: "M (6-7 yrs)",
                stock: "100",
                images: [
                    new File([new Blob(["dummy content"], { type: "image/webp" })], "new-img1.webp", { type: "image/webp" }),
                    null,
                    new File([new Blob(["dummy content"], { type: "image/webp" })], "new-img7.webp", { type: "image/webp" }),
                    null,
                    null,
                ], // Mocking two image files with dummy content

            };

            setProduct(fetchedProduct);
            setImagePreviews(
                fetchedProduct.images.map((img) => (img ? URL.createObjectURL(img) : null))
            );
        };
    ...
    const handleSubmit = (e) => {
        ...
        console.log("Product updated:", { ...product, images: imagesToSubmit });
                        ...
                        <div className="space-y-6">
                            <label className="block">
                                ...
                                <input
                                    ...
                                    required
                                    className="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-purple-500 focus:border-purple-500 transition duration-300"
                                />
                            </label>
                            ...
                            <label className="block">
                                ...
                                <textarea
                                    ...
                                    required
                                    rows="6"
                                    className="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 resize-none focus:outline-none focus:ring-4 focus:ring-purple-500 focus:border-purple-500 transition duration-300"
                                />
                            </label>
                        ...
                        <div className="space-y-6">
                            ...
                            <label className="block">
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    required
                                    className="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-4 focus:ring-purple-500 focus:border-purple-500 transition duration-300"
                                >
                            ...
                            <label className="block">
                                <span className="text-gray-700 font-semibold mb-1 block">Size</span>
                                <select
                                    name="size"
                                    value={product.size}
                                    onChange={handleChange}
